...
export default function App() {
  ...
  return (
    ...
    <Routes>
    <Route index path= '/categories' element= {<Categories/>}></Route>
    <Route path='/categories/:categoryId' element={<ListManga/>}></Route>
    <Route index path='/' element={<Main search={search}/>}></Route>
    <Route index path='/manga/:id' element={<Manga/>}></Route>
